...
function BlogId() {
	...
	return (
		<div className="container1 pt-32">
			...
			<h1 className="font-inter-600 text-[60px] leading-[64px] mt-10 max-lg:leading-10 max-lg:text-[36px]">{blog.title}</h1>
			...
			<div className="flex gap-4 items-center mt-12">
				...
				<div>
					<p className="font-inter-500 max-md:text-sm">Денис Иванов</p>
					<p className="font-inter-500 text-black/60 max-md:text-sm">
						Менеджер по внедрению сварочных ячеек
					</p>
				</div>
         </div>
